...
Файлы в `assets/` — см. `assets/README.txt`. Имена: `menu.jpg`, `profile.jpg`, `deal.jpg`, `inventory.jpg`, `about.jpg`, `history.jpg`, `requisites.jpg`, `deposit.jpg`, `listing.jpg`. Если файла нет, экран текстом.
